...
```bash
# Base PR (feature/auth-1) merged to master
# Update PR 2's target

# 1. Fetch latest master
git checkout master && git pull

# 2. Change PR 2's base branch to master
gh pr edit <pr-2-number> --base master

# 3. Rebase PR 2 on master
...
1. **Keep PRs focused** - One logical unit of work each
2. **Make each PR reviewable** - Complete, independently reviewable slice
